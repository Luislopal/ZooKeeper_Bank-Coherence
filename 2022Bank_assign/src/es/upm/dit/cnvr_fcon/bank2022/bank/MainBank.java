...
public class MainBank {
	...
	private void configureLogger1() {
		...
		handler.setLevel(Level.INFO); //FINEST
	...
	private void initMembers(Operations operations) {
	...
	private void put(Client map, Operations operations) {
		operations.put(map);
	}

	//////////////////////////////////////////////////////////////////////////

	private Integer get(int accNumber, Operations operations) {
	...
	private Integer remove(int accNumber, Operations operations) {
	...
	private Integer update(int accNumber, int balance, Operations operations) {
